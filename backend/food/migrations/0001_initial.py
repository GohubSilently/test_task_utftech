# Generated by Django 6.0.3 on 2026-03-30 15:49
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_id', models.PositiveIntegerField(blank=True, default=10, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.PositiveIntegerField(verbose_name='Код поставщика')),
                ('internal_code', models.PositiveIntegerField(blank=True, null=True, unique=True, verbose_name='Код в приложении')),
